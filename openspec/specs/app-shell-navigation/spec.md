...
Shell de navegación principal de la app: barra inferior con los 3 destinos fijos (Inicio, Historial, Etiquetas). Es la infraestructura de navegación sobre la que viven todas las demás capabilities de producto.
