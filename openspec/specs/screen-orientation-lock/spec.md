...
Orientación de pantalla del shell de la app: fija en vertical, con un contrato de excepción reservado para una capability futura (visor de imagen a pantalla completa).
